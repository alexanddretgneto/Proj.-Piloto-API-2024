# Generated by Django 5.0.1 on 2024-02-08 03:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Crie aqui o  gênero do livro', max_length=502)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('summary', models.TextField(help_text='Descrição do livro', max_length=1000)),
                ...
                ('genre', models.ManyToManyField(help_text='Selecione o genero do livro', to='catalog.genre')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
